...
property4 = Property.create(description: "Magnifique Appartement avec vue sur la ville", property_type: "House", price: "23000000", living_space: "160", land_surface: "160", address: "Flic en Flac", parking_space: 4, pool: true, room: 4, bedrooms: 2, bathroom: 1, sea_view: false, user_id: user1.id)
property5 = Property.create(description: "Magnifique Appartement avec vue sur la ville", property_type: "Villa", price: "22000000", living_space: "160", land_surface: "160", address: "Grand-baie", parking_space: 4, pool: true, room: 4, bedrooms: 2, bathroom: 1, sea_view: false, user_id: user2.id)
...
property8 = Property.create(description: "Magnifique Appartement avec vue sur la ville", property_type: "Villa", price: "19000000", living_space: "160", land_surface: "160", address: "Phoenix, Mauritius", parking_space: 4, pool: true, room: 4, bedrooms: 2, bathroom: 1, sea_view: false, user_id: user2.id)
...
property10 = Property.create(description: "Magnifique Appartement avec vue sur la ville", property_type: "House", price: "20000000", living_space: "160", land_surface: "160", address: "Phoenix, Mauritius", parking_space: 4, pool: true, room: 4, bedrooms: 2, bathroom: 1, sea_view: false, user_id: user1.id)
property11 = Property.create(description: "Magnifique Appartement avec vue sur la ville", property_type: "Villa", price: "10000000", living_space: "160", land_surface: "160", address: "Phoenix, Mauritius", parking_space: 4, pool: true, room: 4, bedrooms: 2, bathroom: 1, sea_view: false, user_id: user2.id)
property12 = Property.create(description: "Magnifique Villa avec vue sur la mer", property_type: "Villa", price: "18000000", living_space: "800", land_surface: "1600", address: "Port Louis", parking_space: 3, pool: true, room: 4, bedrooms: 4, bathroom: 2, sea_view: true, user_id: user2.id)
...
property14 = Property.create(description: "Magnifique Appartement avec vue sur la ville", property_type: "House", price: "80000000", living_space: "160", land_surface: "160", address: "Flic en Flac", parking_space: 4, pool: true, room: 4, bedrooms: 2, bathroom: 1, sea_view: false, user_id: user1.id)
property15 = Property.create(description: "Magnifique Appartement avec vue sur la ville", property_type: "Villa", price: "10000000", living_space: "160", land_surface: "160", address: "Grand-baie", parking_space: 4, pool: true, room: 4, bedrooms: 2, bathroom: 1, sea_view: false, user_id: user2.id)
...
property1.photos.attach(io: File.open("app/assets/images/seed/house1.png"), filename: "house1.png")
property2.photos.attach(io: File.open("app/assets/images/seed/villa1.png"), filename: "villa1.png")
property3.photos.attach(io: File.open("app/assets/images/seed/appart1.png"), filename: "appart1.png")
property4.photos.attach(io: File.open("app/assets/images/seed/house1.png"), filename: "house1.png")
property5.photos.attach(io: File.open("app/assets/images/seed/villa1.png"), filename: "villa1.png")
property6.photos.attach(io: File.open("app/assets/images/seed/appart1.png"), filename: "appart1.png")
property7.photos.attach(io: File.open("app/assets/images/seed/house1.png"), filename: "house1.png")
property8.photos.attach(io: File.open("app/assets/images/seed/villa1.png"), filename: "villa1.png")
property9.photos.attach(io: File.open("app/assets/images/seed/appart1.png"), filename: "appart1.png")
property10.photos.attach(io: File.open("app/assets/images/seed/house1.png"), filename: "house1.png")
property11.photos.attach(io: File.open("app/assets/images/seed/villa1.png"), filename: "villa1.png")
property12.photos.attach(io: File.open("app/assets/images/seed/appart1.png"), filename: "appart1.png")
property13.photos.attach(io: File.open("app/assets/images/seed/house1.png"), filename: "house1.png")
property14.photos.attach(io: File.open("app/assets/images/seed/villa1.png"), filename: "villa1.png")
property15.photos.attach(io: File.open("app/assets/images/seed/appart1.png"), filename: "appart1.png")
...
booking7 = Booking.create(slot_id: slot7.id, user_id: user2.id)
booking8 = Booking.create(slot_id: slot8.id, user_id: user3.id)
booking9 = Booking.create(slot_id: slot9.id, user_id: user1.id)
booking10 = Booking.create(slot_id: slot10.id, user_id: user2.id)
booking11 = Booking.create(slot_id: slot11.id, user_id: user3.id)
booking12 = Booking.create(slot_id: slot12.id, user_id: user1.id)
booking13 = Booking.create(slot_id: slot13.id, user_id: user2.id)
booking14 = Booking.create(slot_id: slot14.id, user_id: user3.id)
booking15 = Booking.create(slot_id: slot15.id, user_id: user1.id)
